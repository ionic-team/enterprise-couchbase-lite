...
export abstract class Engine {
  ...
  abstract LiveQuery_Execute(database: Database, query: Query, cb: (data: any) => any, err: (err: any) => void): void;
  abstract async LiveQuery_End(database: Database, id: number): Promise<void>;
